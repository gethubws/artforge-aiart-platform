...
public interface ArtworkService {
    ArtworkDtos.ArtworkPage myArtworks(Long userId, int page, int size, String keyword, List<Long> tagIds, String visibility, String status);

    ArtworkDtos.ArtworkPage publicArtworks(int page, int size, String keyword, List<Long> tagIds);
